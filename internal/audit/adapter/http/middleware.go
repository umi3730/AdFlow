...
func auditedAction(method, route string) (string, string, bool) {
	...
	actions := map[string]actionDefinition{
		http.MethodPost + " /v1/simulations/decisions":                       {"SIMULATE_DECISION", "simulation"},
		http.MethodPost + " /v1/campaigns/:id/creatives/:creativeId/enable":  {"ENABLE_CREATIVE", "creative"},
		http.MethodDelete + " /v1/campaigns/:id":                             {"DELETE_CAMPAIGN", "campaign"},
		http.MethodDelete + " /v1/campaigns/:id/creatives/:creativeId":       {"DELETE_CREATIVE", "creative"},
		http.MethodDelete + " /v1/profiles/:userId":                          {"DELETE_PROFILE", "profile"},
